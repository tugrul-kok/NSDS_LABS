...
<simconf>
  ...
  <simulation>
    ...
    <motetype>
      ...
      <identifier>mtype950</identifier>
      <description>client</description>
      <source>[CONTIKI_DIR]/lab/eval-23/udp-client.c</source>
    ...
    <motetype>
      ...
      <source>[CONTIKI_DIR]/lab/eval-23/udp-server.c</source>
    ...
    <mote>
      <interface_config>
        ...
        <x>72.23699715426697</x>
        <y>54.76535104517727</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
      ...
      <motetype_identifier>mtype950</motetype_identifier>
    </mote>
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>97.57160108601421</x>
        <y>64.33145197239273</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
    ...
    <mote>
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>98.43115909655928</x>
        <y>41.75759903941121</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.contikimote.interfaces.ContikiMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.3373525850999535 0.0 0.0 1.3373525850999535 94.43473219194314 49.971956488407635</viewport>
    </plugin_config>
    <width>400</width>
    <z>1</z>
    <height>400</height>
